...
DataRowRawList::DataRowRawList() {}
DataRowRawList::~DataRowRawList()
{
    while (!m_list.isEmpty()){
        DataRowRaw* row_raw = m_list.last();
        m_list.removeLast();
        delete row_raw;
    }
}
DataRowRaw* DataRowRawList::add()
{
    m_list.append( new DataRowRaw() );
    return m_list.last();
}
QList<DataRowRaw *> DataRowRawList::list() 
{ 
    return m_list; 
}
